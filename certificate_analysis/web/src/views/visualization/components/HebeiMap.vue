<template>
  <div id="hebei-map" class="hebei-map" :style="style"></div>
</template>

<script>
// import * as geoJson from '../data/data-1633939162808-GypYIdFqt.geojson'
import * as geoJson from '../data/hebei.json'
...
export default {
  ...
  methods: {
    render() {
      const myChart = this.$echarts.init(document.getElementById("hebei-map"));
